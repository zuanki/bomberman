...
public class Sprite {
    ...
    |--------------------------------------------------------------------------
     */
    public static Sprite grass = new Sprite(DEFAULT_SIZE, 6, 0, SpriteSheet.newTiles, 16, 16);
    public static Sprite brick = new Sprite(DEFAULT_SIZE, 7, 0, SpriteSheet.modernTiles, 16, 16);
    public static Sprite wall = new Sprite(DEFAULT_SIZE, 5, 0, SpriteSheet.modernTiles, 16, 16);
    ...
    public static Sprite movingSprite(Sprite normal, Sprite x1, Sprite x2, long animate, int time) {
        long calc = animate % time;
        int diff = time / 3;
